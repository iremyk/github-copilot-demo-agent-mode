...
mode: 'agent'
model: GPT-4.1
description: 'Update the Octofit Tracker Django app to support MongoDB and implement REST API endpoints for users, teams, activities, leaderboard, and workouts collections.'
---
